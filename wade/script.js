document.addEventListener('DOMContentLoaded', () => {
    ...
    const timelineData = {
        '2017': 'A WADE nasce da vontade de desenvolver produtos inovadores que unam alta performance, sustentabilidade e bem-estar. Os primeiros estudos foram focados em biotecnologia aplicada aos cuidados pessoais e domésticos.',
        '2019': 'Após diversos testes e validações, a WADE lança suas primeiras soluções voltadas para limpeza e cuidados pessoais, recebendo excelente aceitação dos consumidores.',
        '2020': 'Com o sucesso inicial, a marca expande seu portfólio de produtos e sua capacidade de produção, consolidando-se no mercado regional.',
        '2023': 'A WADE atinge um crescimento expressivo em nível nacional, com presença em grandes redes de varejo e novos canais de distribuição.',
        '2024': 'Lançamento de novas linhas de produtos inovadores, focando ainda mais em tecnologia sustentável e fórmulas de alta performance.'
    };
